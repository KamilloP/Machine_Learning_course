...
class SwiGLU(nn.Module):
    def __init__(
        ...
        # training. Also they propose changing hidden dimension to 2/3 of original hidden dim (from 
        # ff layer linear projection) because SwiGLU uses 3 linear projections instead of 2. Here 
        # I can control scale hyperparameter, but I have decided to keep it 4.
    def swish(self, x):
